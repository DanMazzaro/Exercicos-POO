...
produto1 = Produto('Leite', 'R$ 4,59', '500 unidades', '111 111', 'Tirol')
produto2 = Produto('Café', 'R$ 20,50', '300 unidades', '222 222', 'Melita')
produto3 = Produto('Pão Fatiado ', 'R$ 7,00', '450 unidades', '333 333', 'Pullman')
